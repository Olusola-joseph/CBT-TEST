// Biology CBT Exam Application - Robust functionality with proper error handling
// Import database functionality

class BiologyCBTExamApp {
    constructor() {
        ...
        this.subjectType = 'Biology'; // Track subject type for different handling
    ...
    async loadQuestionsForSubject(subject) {
        try {
            ...
            if (subjectData) {
                // Store figures separately for later reference
                ...
                // For Biology, use all questions in their original order
                ...
                console.log(`Loaded ${this.questions.length} biology questions for ${this.selectedYear} with sequential IDs`);
    ...
    questionNeedsDiagram(questionText) {
        const diagramKeywords = [
            'cell', 'organ', 'organism', 'tissue', 'organelle', 'nucleus', 'mitochondria', 'chloroplast',
            'membrane', 'cytoplasm', 'chromosome', 'DNA', 'RNA', 'protein', 'enzyme', 'hormone',
            'leaf', 'root', 'stem', 'flower', 'fruit', 'seed', 'vascular', 'xylem', 'phloem',
            'circulatory', 'respiratory', 'digestive', 'nervous', 'excretory', 'reproductive',
            'skeleton', 'muscle', 'bone', 'joint', 'heart', 'lung', 'kidney', 'liver', 'brain',
            'plant', 'animal', 'organism', 'ecosystem', 'food chain', 'food web', 'habitat', 'niche',
            'photosynthesis', 'respiration', 'metabolism', 'growth', 'reproduction', 'evolution',
            'genetics', 'heredity', 'allele', 'gene', 'chromosome', 'meiosis', 'mitosis',
            'microscope', 'slide', 'specimen', 'staining', 'magnification', 'lens',
            'diagram', 'figure', 'image', 'graph', 'plot', 'chart', 'illustration',
            'structure', 'function', 'process', 'cycle', 'pathway', 'system'
        ];
    ...
    renderOptions(question) {
        ...
        // For biology questions, render standard radio button options
    ...
    finishReview() {
        ...
        this.selectedSubject = 'Biology'; // Reset to Biology
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        const app = new BiologyCBTExamApp();
        window.bioApp = app; // Make it accessible globally for debugging
    } catch (error) {
        console.error('Error initializing Biology CBT Exam App:', error);
...
window.addEventListener('beforeunload', (e) => {
    if (window.bioApp && window.bioApp.currentScreen === 'exam-screen') {
        e.preventDefault();
